...
const Tags = [`homework`, `theory`, `practice`, `intensive`, `keks`, `comments`, `exam`];
...
const getRandomDate = () => {
  ...
  const differentValue = sign * getRandomIntegerNumber(0, 7);

  targetDate.setDate(targetDate.getDate() + differentValue);
